...
*/
async function linkSubscription(ppid, eventHandler) {
  try {
 ...
 * @param {object} eventHandler
*/
async function linkSubscriptions(slDataArr, eventHandler) {
 ...
 */
async function analyticsEventLogger(subscription, eventHandler) {
  const manager = await subscription.getEventManager();
...
await analyticsEventLogger(subscriptions, eventHandler);
