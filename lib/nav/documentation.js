...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        url: '/swg/update-sku',
        content: 'app/content/update-sku.md',
        script: 'js/update-sku.js',
      },
      {
        label: 'Add Subscribe with Google button (ESM)',
        url: '/swg/add-button-esm',
        content: 'app/content/add-swg-button-esm.md',
        script: 'js/add-swg-button-esm.js',
      },
      {
        label: 'Validate purchases payloads',
        url: '/swg/validate',
        content: 'app/content/validate-purchases.md',
        script: 'js/validate-purchases.js',
      },
    ],
  },
  {
    ...
    links: [
      {
        label: 'Implement with Button',
        url: '/preferred-sources/button',
        content: 'app/content/preferred-sources-button.md',
      },
      {
        label: 'Implement with HTML',
        url: '/preferred-sources/html',
        content: 'app/content/preferred-sources-html.md',
      },
      {
        label: 'Implement with JS',
        url: '/preferred-sources/js',
        content: 'app/content/preferred-sources-js.md',
        script: 'js/preferred-sources-js.js',
      },
      {
        label: 'Implement with ESM',
        url: '/preferred-sources/esm',
        content: 'app/content/preferred-sources-esm.md',
        script: 'js/preferred-sources-esm.js',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: 'Manual CTA invocation (ESM)',
        url: '/newsletter/manual-esm',
        content: 'app/content/newsletter-manual-esm.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/newsletter-manual-esm.js',
      },
      {
        label: 'Automatic CTA invocation',
    ...
    links: [
      {
        label: 'Manual CTA invocation',
        url: '/survey/manual',
        content: 'app/content/survey-manual.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/survey-manual.js',
      },
      {
        label: 'Manual CTA invocation (ESM)',
        url: '/survey/manual-esm',
        content: 'app/content/survey-manual-esm.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/survey-manual-esm.js',
      },
    ],
    options: {
      // suppressInNav: true,
  ...
  {
    section: 'Rewarded Ads',
    links: [
      {
        label: 'Manual CTA invocation',
        url: '/rewarded-ads/manual',
        content: 'app/content/rewarded-ads-manual.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/rewarded-ads-manual.js',
      },
      {
        label: 'Manual CTA invocation (ESM)',
        url: '/rewarded-ads/manual-esm',
        content: 'app/content/rewarded-ads-manual-esm.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/rewarded-ads-manual-esm.js',
      },
    ],
    options: {
      // suppressInNav: true,
  ...
  },
  {
    ...
    links: [
      {
        label: 'Manual CTA invocation',
        url: '/custom-cta/manual',
        content: 'app/content/custom-cta-manual.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/custom-cta-manual.js',
      },
      {
        label: 'Manual CTA invocation (ESM)',
        url: '/custom-cta/manual-esm',
        content: 'app/content/custom-cta-manual-esm.md',
        options: {
          suppressStructuredDataMarkup: true,
          lang: 'en',
        },
        script: 'js/custom-cta-manual-esm.js',
      },
    ],
    options: {
      // suppressInNav: true,
  ...
  },
  {
    ...
    links: [
      {
        label: 'Manual CTA invocation',
        url: '/reader-registration',
        content: 'app/content/reader-registration.md',
        script: 'js/reader-registration.js',
      },
      {
        label: 'Automatic CTA invocation',
        url: '/reader-registration/automatic',
        content: 'app/content/reader-registration-automatic.md',
        script: 'js/reader-registration-automatic.js',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: 'Extended Access from Search (EAfS)',
        url: '/extended-access/eafs',
        content: 'app/content/eafs.md',
        script: 'js/eafs.js',
      },
      {
        label: 'Registration Flow (ESM)',
        url: '/extended-access/registration-esm',
        content: 'app/content/extended-access-registration-esm.md',
        script: 'js/extended-access-esm.js',
      },
    ],
  },
  {
    ...
    links: [
      {
        label: 'Subscription Linking',
        url: '/subscription-linking',
        content: 'app/content/subscription-linking.md',
        script: 'js/subscription-linking.js',
      },
      {
        label: 'Subscription Linking (ESM)',
        url: '/subscription-linking-esm',
        content: 'app/content/subscription-linking-esm.md',
        script: 'js/subscription-linking-esm.js',
      },
      {
  ...
  {
    section: 'Cancelling Entitlements Plans or Making Refunds',
    links: [
      {
        label: 'Cancellation API',
        url: '/reference/cancellation-api',
        content: 'app/content/cancellation-api.md',
        script: 'js/cancellation-api.js',
      },
    ],
  },
  {
