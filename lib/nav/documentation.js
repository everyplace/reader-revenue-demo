...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: 'Implement with JS (IIFE)',
        url: '/preferred-sources/js-iife',
        content: 'app/content/preferred-sources-js-iife.md',
        script: 'js/preferred-sources-iife.js',
      },
      {
        label: 'Implement with JS (ESM)',
        url: '/preferred-sources/js-esm',
        content: 'app/content/preferred-sources-js-esm.md',
